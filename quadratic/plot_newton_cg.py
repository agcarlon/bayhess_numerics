...
def plot_newton_cg(folder='sgd_mice_bay', method='sgd_mice_bay'):
    ...
    with open(f'{folder}/{method}.txt') as f:
        lines = f.readlines()
...
if __name__ == '__main__':
    plot_newton_cg(method='sgd_mice_bay_1e6')
    # plot_newton_cg(method='sgd_mice_bay_inv')
    # plot_newton_cg(folder='sgd_mice_bay', method='sgd_mice_bay_lr')
    # plot_newton_cg(folder='sgd_mice_bay', method='sgd_mice_bay_lr_full')